...
nullJuryCount: number | undefined;
  ...
  assignStages() {
    ...
    this.service.assignJuriesToStages( this.filiereId!, selectedProfesseurIds,year).subscribe(
      (response) => {
  ...
  countNullJuryStages() {
    ...
    this.service.countStagesWithNullJury(year, this.filiereId!).subscribe(
      (count) => {
        this.nullJuryCount = count;
