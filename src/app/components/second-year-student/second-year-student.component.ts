...
@Component({
  ...
  templateUrl: './second-year-student.component.html',
  styleUrls: ['./second-year-student.component.css']
})
export class SecondYearStudentComponent {
  ...
  fetchSecondYearEtudiants() {
    this.service.getEtudiantsByFiliereId(this.filiereId!).subscribe((etudiants) => {
      ...
      this.firstYearEtudiants = etudiants.filter((etudiant) => etudiant.niveau === '2');
    });
  }
